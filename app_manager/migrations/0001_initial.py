...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('level', models.ManyToManyField(to='app_manager.BloomLevel')),
            ],
        ),
        migrations.CreateModel(
            name='BloomVerb',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('milestone_deliverables', models.ManyToManyField(to='app_manager.Deliverable')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem_hint_and_advise', models.OneToOneField(on_delete='cascade', to='app_manager.HintAndAdvise')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version_author', models.OneToOneField(on_delete='cascade', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Workshop',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill_name', models.OneToOneField(on_delete='cascade', to='app_manager.Skill')),
            ],
        ),
        migrations.CreateModel(
            name='SkillFamily',
            fields=[
                ...
                ('bloom_ref', models.ManyToManyField(to='app_manager.BloomTaxonomy')),
            ],
        ),
        migrations.AddField(
            model_name='skill',
            name='skill_family',
            field=models.ManyToManyField(to='app_manager.SkillFamily'),
        ),
        migrations.AddField(
            model_name='skill',
            name='skill_verb',
            field=models.ManyToManyField(to='app_manager.BloomTaxonomy'),
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='app_manager.ExerciseManipulation'),
        ),
        migrations.AddField(
            model_name='exercise',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cctl_skill', models.ManyToManyField(to='app_manager.Skill')),
            ],
        ),
        migrations.CreateModel(
            name='CCTL',
        ...
        migrations.AddField(
            ...
            name='taxonomy_verb',
            field=models.ManyToManyField(to='app_manager.BloomVerb'),
        ),
        migrations.CreateModel(
            name='APPMetaData',
            fields=[
